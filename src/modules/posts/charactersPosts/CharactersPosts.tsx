...
const CharactersPosts = observer(() => {
   ...
   const vars = {
      page: characters.isFilter ? characters.filteredPage  : page  ,
   ...
   const {loadMoreCharacters } = useInfiniteLoad(endpoints, vars, setCharactersData, characters, setHasMoreCharacters,hasMoreCharacters,characters.isFilter ? setPageFiltered : setPage)
   ...
   return (
      <>
      {pageFiltered} {characters.filteredPage} ===========  {page} {characters.page} ========= {charactersData.length} {characters.filteredCharactersData.length}
